 ...
 */
public class MaxDrinks extends Activity implements View.OnClickListener {
    ...
    public void clickedLogYes() {
        Intent intent = new Intent(MaxDrinks.this, DrunkLog.class);
        startActivity(intent);
        finish();
    }

    public void clickedLogNo() {
        Intent intent = new Intent(MaxDrinks.this, Landing_Page.class);
        startActivity(intent);
        finish();
    }
