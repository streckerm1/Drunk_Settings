 ...
 */
public class MedDrinks extends Activity implements View.OnClickListener {
    ...
    public void clickedLogYes() {
        Intent intent = new Intent(MedDrinks.this, DrunkLog.class);
        startActivity(intent);
        finish();
    }

    public void clickedLogNo() {
        Intent intent = new Intent(MedDrinks.this, Landing_Page.class);
        startActivity(intent);
        finish();
    }
