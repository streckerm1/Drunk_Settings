 ...
 */
public class ExtraDrinks extends Activity implements View.OnClickListener{
    ...
    public void clickedLogYes() {
        Intent intent = new Intent(ExtraDrinks.this, DrunkLog.class);
        startActivity(intent);
        finish();
    }

    public void clickedLogNo() {
        Intent intent = new Intent(ExtraDrinks.this, Landing_Page.class);
        startActivity(intent);
        finish();
    }
